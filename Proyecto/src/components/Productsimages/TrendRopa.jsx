    ...
    return (
        <div>
          <ul className='flex bg-[#ebebeb] pl-4 pr-4 pt-2 pb-2 mt-3 border border-solid border-black rounded-md'>
            {TPRarray.map((ropa) =>
              <Link key={ropa.id}>
                <li key={ropa.id} className='flex justify-center items-center m-1 hover:brightness-75 hover:cursor-pointer'>
                  <div className='lg:w-[250px] lg:h-[300px] md:w-[180px] md:h-[280px] shadow-inner border-solid border-2 border-black bg-[#f2f0f0] lg:mt-4 md:flex flex-col md:justify-center md:items-center w-[160px] h-[290px] mt-9 rounded-lg '>
